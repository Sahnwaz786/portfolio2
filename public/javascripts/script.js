...
const observer = new IntersectionObserver((entries) => {
  ...
  */
  ...
  let project_titles = ["Book Store", "Hotel Odisej", "Project 3"];
  let project_texts = [
    ...
    "Hotel Odisej front-end web site . This website incorporates  navigation bars, buttons, and SVG graphics. Different  fonts, and visual styles are used to create a dynamic and engaging user interface.",
  ...
  let img_srcs = [
    "https://plus.unsplash.com/premium_photo-1669652639356-f5cb1a086976?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Ym9va3MlMjBzdG9yZXxlbnwwfHwwfHx8MA%3D%3D",
    "https://hotelodisej.com/wp-content/uploads/bf-advanced-images/209/ALH_Odisej_exterior_aerial_07-scaled-1920x0.jpg",
  ...
  let demo_links = ["https://book-store-q20f.onrender.com", "https://sahnwaz786.github.io/Final-B24-Project/", "#"];
  let code_links = ["https://github.com/Sahnwaz786/Book-Store-Project", "https://github.com/Sahnwaz786/Final-B24-Project", "#"];
  let index = 0;
  /*
